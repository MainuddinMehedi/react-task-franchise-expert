  ...
  return (
    <div className="flex justify-center">
      <div className="w-10/12">
        <div className="h-[370px] w-full flex justify-between">
          {/* left side */}
          <div className="w-[40%] py-12 pr-9 space-y-6">
          ...
          {/* right side */}
          <div className="w-[60%] flex justify-between px-5">
            <div className="relative">
              {/* first slide */}
              <div
                className={`h-[245px] w-[404px] bg-white relative p-9 m-9 shadow-lg rounded-lg z-40 transform transition-all duration-500 ease-in-out ${
                  transitioning
